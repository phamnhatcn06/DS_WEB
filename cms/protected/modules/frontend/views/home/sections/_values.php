    ...
    <div class="row justify-content-end">
      <div class="col-12 col-lg-9 col-xl-6">
        <h2 class="giatri-title text-lg-end" data-reveal="right">
          Xây dựng niềm tin,<br><span> kiến tạo giá trị</span>
        </h2>
