<?php
/**
 * Trang chủ (module frontend) — thân 10 section. Header/Footer/<head> nằm ở
 * layout frontend.views.layouts.main.
 *
 * Thân hiện còn tĩnh; các bước sau tách thành partial sections/_*.php và lặp qua
 * payload ($heroSlides, $sectors, $projects, $coreValues, $milestones, $partners,
 * $newsCategories, $newsPosts) do HomeController truyền vào.
 *
 * @var Controller $this
 * @var string $root  Base URL tới gốc dự án (chứa /assets).
 */
