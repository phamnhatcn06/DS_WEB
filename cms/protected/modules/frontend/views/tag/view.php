 ...
 *
 * Dải đầu trang (tagp-hero) nền tối để header dùng chung (chữ trắng, vốn thiết
 * kế đè lên hero tối) vẫn đọc được; nội dung phía dưới nền sáng.
 *
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <a href="<?php echo CHtml::encode($home); ?>#linh-vuc" class="tagp-card">
                <div class="tagp-card-media">
                  ...
                  <span class="tagp-card-chip tagp-card-chip--gold">Lĩnh vực</span>
                </div>
