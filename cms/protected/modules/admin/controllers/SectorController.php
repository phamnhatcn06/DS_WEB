...
class SectorController extends AdminCrudController
{
    ...
    protected function formFields()
    {
        return array(
            ...
            array('name' => 'stat1_label', 'width' => 5),
            array('name' => 'stat1_short_label', 'width' => 3,
                'hint' => 'Nhãn ngắn ở khối trích dẫn (Section 2). Trống → dùng nhãn dài.'),
            array('name' => 'stat2_value', 'width' => 2),
            array('name' => 'stat2_suffix', 'width' => 2),
            array('name' => 'stat2_label', 'width' => 5),
            array('name' => 'stat2_short_label', 'width' => 3,
                'hint' => 'Nhãn ngắn ở khối trích dẫn (Section 2). Trống → dùng nhãn dài.'),
