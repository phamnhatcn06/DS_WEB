...
class ProjectController extends AdminCrudController
{
    ...
    protected function formFields()
    {
        return array(
            ...
            array('name' => 'summary', 'type' => 'textarea', 'width' => 12, 'rows' => 4),
            array('name' => 'investment_amount', 'type' => 'number', 'width' => 6, 'step' => '1',
                'hint' => 'Nhập số nguyên VNĐ. Chuỗi hiển thị sẽ tự sinh nếu để trống ô bên cạnh.'),
            array('name' => 'investment_display', 'width' => 6),
            array('name' => 'scale_display', 'width' => 6,
                'hint' => 'Ví dụ: 1.100 căn hộ'),
            array('name' => 'start_date', 'type' => 'date', 'width' => 6),
            array('name' => 'completion_date', 'type' => 'date', 'width' => 6),
            array('name' => 'project_status', 'type' => 'select', 'width' => 6,
            ...
            array('name' => 'sort_order', 'type' => 'number', 'width' => 12),
